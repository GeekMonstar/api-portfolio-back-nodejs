...
function createAuth(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name_1, email, password, auth, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, name_1 = _a.name, email = _a.email, password = _a.password;
                    return [4 /*yield*/, auth_model_1.default.create({ name: name_1, email: email, password: password })];
                case 1:
                    auth = _b.sent();
                    if (auth) {
...
function authentification(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, authBool, auth, token;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, email = _a.email, password = _a.password;
                    return [4 /*yield*/, auth_model_1.default.authentification(email, password)];
                case 1:
                    authBool = _b.sent();
                    if (!authBool) return [3 /*break*/, 4];
                    return [4 /*yield*/, auth_model_1.default.findOne({ email: email })];
                case 2:
                    auth = _b.sent();
                    return [4 /*yield*/, (0, jsonwebtoken_1.sign)(__assign({}, auth), "shhhhh")];
                case 3:
                    token = _b.sent();
