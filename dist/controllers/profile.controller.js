...
function createProfile(req, res, newFileName) {
    return __awaiter(this, void 0, void 0, function () {
        var v_profile, profile, profile, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    v_profile = _a.sent();
                    if (!v_profile[0]) return [3 /*break*/, 3];
                    return [4 /*yield*/, profile_model_1.default.findOneAndUpdate({}, { url: newFileName })];
                case 2:
                    profile = _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, profile_model_1.default.create({ url: newFileName })];
                case 4:
                    profile = _a.sent();
                    res.status(200).json(profile);
                    _a.label = 5;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, profile_model_1.default.findOne({})];
                case 1:
                    profile = _a.sent();
                    if (!profile) {
